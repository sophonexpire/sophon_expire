...
function buildProductPayload({ productCode, productName, categoryId = null, unit = "", priceValue = "", description = "" }) {
...
assert.strictEqual(payload.barcode, "SKU-PRICE-1");
...
assert.match(productsHtml, /select\("id, product_code, product_name, category_id, unit, price, description"\)/, "insert/update should return price");
